      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SizedBox(height: 24,),
            CustomText(text: "Please Verify Your Email",fontWeight: FontWeight.bold,color: Colors.white,size: 30,),
            SizedBox(height: 4,),
            CustomText(text: "Enter the 5 digit code we sent by email to ",color: Colors.white,size: 16,),
            SizedBox(height: 4,),
            CustomText(text: "alexa.mate@example.com",color:Color(0xffEDDF99),size: 16,),
            SizedBox(height: 24,),
            OtpTextField(
